<div class="card recipe-search col-12 d-flex align-items-center justify-content-center p-5">
    ...
    <form class=" d-flex flex-column justify-content-center" action="/recipes" method="get" autocomplete="off">
        ...
        <div class="query col-12" id="ingredientsWrapper">
            ...
            <div class="ingredientsForm col-10 row-cols-sm-6 d-flex flex-row justify-content-between">
                ...
                <span onclick="addField(this, 'ingredients')" class="btn btn-success px-3">+</span>
        ...
        <div class="query col-12 " id="excludedWrapper">
            ...
            <div class="excludedForm col-10 d-flex justify-content-between">
                <input type="text" class="border-0 me-2 form-control form-control-sm col-7" name="excluded[]" value=""
                       placeholder="Enter query or ingredient" autofocus />
                <span onclick="addField(this, 'excluded')" class="btn px-3 btn-success">+</span>
                <span onclick="removeField(this)" class="btn btn-success px-3">−</span>
            </div>
        </div>
        <div class="query col-12 " id="excludedWrapper">
        ...
        <div class="query col-12 " id="excludedWrapper">
            <p class="fw-normal" style="text-align: left!important;">Enter the Max Calories<span class="ms-1 small text-muted">(optional)</span></p>
            <div class="col-7 d-flex align-items-center justify-content-between">
        ...
        <!-- Time -->
        <div class="query col-12 " id="excludedWrapper">
            <p class="fw-normal" style="text-align: left!important;">Enter the Min Time<span class="ms-1 small text-muted">(optional)</span></p>
            <div class="col-7 d-flex align-items-center justify-content-between">
        ...
        <div class="query col-12 " id="excludedWrapper">
            <p class="fw-normal" style="text-align: left!important;">Enter the Max Time<span class="ms-1 small text-muted">(optional)</span></p>
            <div class="col-7 d-flex align-items-center justify-content-between">
        ...
        <div class="form-footer d-flex align-items-center justify-content-center">
            <input type="submit" id="search" value="Show Recipes" class="px-5 py-3 btn btn-success"/>
        </div>
    </form>
