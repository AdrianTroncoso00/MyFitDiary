...
class InfoUsuariosModel extends \CodeIgniter\Model {
    ...
    protected $allowedFields = ['genero', 'objetivo','edad','peso','estatura','actividad_fisica','metabolismo_basal','calorias_mantenimiento','calorias_objetivo','nombre_completo','dieta','num_comidas','porcent_breakfast','porcent_brunch','porcent_lunch','porcent_snack','porcent_dinner'];
